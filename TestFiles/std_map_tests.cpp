...
void map_tests()
{
	...
	cout << "map (iterator): ";
	for (std::map<char, int>::iterator it = ft_map.begin(); it != ft_map.end(); it++)
		cout << (*it).first << " = " << (*it).second << ", ";
	cout << "\n" << std::endl;
	cout << "map (const_iterator): ";
	for (std::map<char, int>::const_iterator it = ft_map.begin(); it != ft_map.end(); it++)
		cout << (*it).first << " = " << (*it).second << ", ";
	cout << "\n" << std::endl;
	cout << "map (reverse_iterator): ";
	for (std::map<char, int>::reverse_iterator rit = ft_map.rbegin(); rit != ft_map.rend(); rit++)
		cout << (*rit).first << " = " << (*rit).second << ", ";
	cout << "\n" << std::endl;
	cout << "map (const_reverse_iterator): ";
	for (std::map<char, int>::const_reverse_iterator rit = ft_map.rbegin(); rit != ft_map.rend(); rit++)
		cout << (*rit).first << " = " << (*rit).second << ", ";
	cout << "\n" << std::endl;
	...
	{
		ft_map.insert(std::make_pair(c, i));
	}
	print_map(ft_map, "map");
	print_size(ft_map, "map");
	...
	std::map<char, int>::iterator std_it_half = ft_map_copy.find('n');
	for (std::map<char, int>::iterator it = ft_map_copy.begin(); it != std_it_half; it++)
	...
	std::map<char, int>::iterator find_a = ft_map.find('a');
	std::map<char, int>::const_iterator find_z = ft_map.find('z');
	...
	std::map<char,int>::iterator itlow = ft_map.lower_bound('b');
	std::map<char,int>::iterator itup = ft_map.upper_bound('g');
	...
	std::map<char,int>::key_compare mycomp = ft_map.key_comp();

	char highest_key = 'm';
	std::pair<char,int> highest = *ft_map.find('m');

	std::map<char,int>::iterator it = ft_map.begin();
